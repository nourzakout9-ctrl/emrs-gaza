...
export async function seedAll() {
  ...
  const hospitals = [
    { name:"Al-Shifa Medical Complex",      nameAr:"مجمع الشفاء الطبي",            zone:"gaza",     location:"Rimal, Gaza City",         locationAr:"الرمال، مدينة غزة",         status:"Open", availableBeds:10,  emergencyCapacity:500, staff:60, specialties:"Cardiac, Trauma, Neurology, Surgery, Pediatric, Orthopedics", specialtiesAr:"قلب، إصابات، أعصاب، جراحة، أطفال، عظام", contact:"+970-8-282-8282", responseRate:0.88 },
    { name:"Al-Quds Hospital",              nameAr:"مستشفى القدس",                 zone:"gaza",     location:"Tel Al Hawa, Gaza City",   locationAr:"تل الهوا، مدينة غزة",        status:"Moderate",   availableBeds:22, emergencyCapacity:150, staff:20, specialties:"General, Surgery, Trauma, Orthopedics",                        specialtiesAr:"عام، جراحة، إصابات، عظام",                  contact:"+970-8-282-0820", responseRate:0.88 },
